...
public class polyPanel extends JPanel{
    ...
    public void new_polygon(Polygon given_poly, boolean bspline, boolean fill, boolean draw_drag_box){
        init(given_poly);
        bspline_mode = bspline;
        filled = fill;
        drag_boxes = draw_drag_box;
    }
    public void new_polygon2(Polygon given_poly){
        init(given_poly);
    }
    ...
    public void set_drag_box(boolean set_drag_box){
        drag_boxes = set_drag_box;
    }
